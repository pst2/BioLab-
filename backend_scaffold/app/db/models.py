...
class GeneRecord(Base):
    ...
    genome_assembly: Mapped[str | None] = mapped_column(String(100), index=True, nullable=True)
    taxid: Mapped[int | None] = mapped_column(Integer, index=True, nullable=True)
    accession_version: Mapped[str | None] = mapped_column(String(100), index=True, nullable=True)
