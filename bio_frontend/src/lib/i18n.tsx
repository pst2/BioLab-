...
const dictionary: Record<Language, Record<string, string>> = {
  vi: {
    ...
    "common.close": "Đóng",
    "common.open": "Mở",
    "sidebar.toggleCollapse": "Thu gọn / mở rộng thanh bên",
    "dashboard.openFeature": "Mở",
    "metric.providersActiveUnit": "nhà cung cấp",
    "search.foundRecords": "Tìm thấy {count} bản ghi phù hợp.",
    "blast.advancedHide": "Ẩn tham số BLAST nâng cao",
    "blast.advancedShow": "Tham số BLAST nâng cao (Matrix, E-value, Gaps)",
    "blast.evalueCutoff": "Ngưỡng E-value",
    "blast.scoringMatrix": "Ma trận điểm",
    "blast.gapOpen": "Điểm mở Gap",
    "blast.gapExtend": "Điểm kéo dài Gap",
    "blast.hideAlignment": "Ẩn căn gióng",
    "blast.viewAlignment": "Xem căn gióng",
    "blast.pairwiseHeader": "Căn gióng cặp đôi (Truy vấn vs Đối tượng)",
    "blast.coordinates": "Tọa độ",
    "blast.score": "Điểm",
    "blast.gaps": "Gaps",
    "blast.length": "Độ dài",
    "blast.segmentSummary": "Cặp phân đoạn hoàn chỉnh được tóm tắt từ {source}. Độ dài: {length} gốc, Tương đồng: {identity}%, E-value: {evalue}.",
    "toast.blastSubmitted": "Đã gửi công việc BLAST: {jobId}",
    "toast.blastComplete": "Tìm kiếm BLAST hoàn tất — {count} căn gióng được tìm thấy",
    "toast.blastTimedOut": "Tìm kiếm BLAST quá thời gian chờ. Vui lòng thử lại.",
    "api.pubmedPlaceholder": "Truy vấn PubMed…",
    "api.responseJson": "Phản hồi JSON",
    "api.requestFailed": "Yêu cầu thất bại",
    "export.downloadFasta": "Tải .FASTA",
    "export.downloadGenbank": "Tải .GenBank (.gb)",
    "export.downloadBed": "Tải .BED Exons",
    "export.downloadJson": "Tải .JSON Metadata",
    "export.copyJson": "Sao chép JSON vào Clipboard",
    "detail.confidence": "Độ tin cậy",
    "detail.confidenceHigh": "Cao",
    "detail.residues": "Residue",
    "detail.tooLargeForGc": "Quá lớn để tính GC content tự động ({length} bp)",
    "detail.largeScaleTitle": "Trình tự quy mô lớn ({length} bp)",
    "detail.largeScaleDesc": "Đếm bazơ chi tiết được bỏ qua cho các bản ghi nhiễm sắc thể/scaffold lớn. Bạn có thể duyệt và xem trực quan toàn bộ trình tự trong Genome Browser bên dưới.",
    "detail.moreCharacters": "còn {count} ký tự khác (hãy copy để lấy toàn bộ chuỗi)",
    "detail.showingOf": "Đang hiển thị 1–{shown} trên {total} {unit}",
    "browser.title": "Trình duyệt hệ gene (Genome Browser)",
    "browser.loading": "Đang khởi tạo IGV Genome Browser…",
    "browser.loadingSub": "Đang lấy trình tự từ NCBI — có thể mất vài giây.",
    "browser.unavailable": "Trình duyệt hệ gene không khả dụng",
    "browser.unavailableSub": "Không có accession hoặc mã định danh trình tự hợp lệ cho bản ghi này.",
    "browser.viewOnNcbi": "Xem trên NCBI",
    "browser.error": "Lỗi trình duyệt hệ gene",
    "browser.rateLimit": "Đã đạt giới hạn tần suất NCBI",
    "browser.rateLimitSub": "NCBI đang tạm thời giới hạn yêu cầu từ máy chủ này. Tình trạng này thường được giải quyết sau vài phút. Bạn vẫn có thể xem trình tự trực tiếp trên NCBI.",
    "browser.tryAgain": "Thử lại",
    "browser.region": "Vùng",
    "error.somethingWrong": "Đã xảy ra lỗi",
    "error.description": "Ứng dụng gặp sự cố không mong muốn. Vui lòng thử lại hoặc quay về trang chủ.",
    "error.tryAgain": "Thử lại",
    "error.home": "Trang chủ",
    "pubmed.badge": "NCBI PubMed Literature",
    "pubmed.title": "Khám phá tài liệu y sinh PubMed",
    "pubmed.desc": "Tìm kiếm tài liệu học thuật y sinh trực tiếp từ NCBI PubMed, xem tóm tắt, thuật ngữ MeSH và xuất trích dẫn định dạng BibTeX / RIS.",
    "pubmed.placeholder": "Nhập thuật ngữ y khoa hoặc tên gene, vd: cancer, BRCA1, covid...",
    "pubmed.searchButton": "Tìm kiếm",
    "pubmed.searching": "Đang tìm kiếm...",
    "pubmed.quickExamples": "Mẫu tìm nhanh",
    "pubmed.statArticles": "Bài báo",
    "pubmed.statWithAbstract": "Có tóm tắt",
    "pubmed.statJournals": "Tạp chí",
    "pubmed.statWithDoi": "Có DOI",
    "pubmed.timeline": "Dòng thời gian xuất bản",
    "pubmed.topJournals": "Tạp chí phổ biến",
    "pubmed.emptyTitle": "Chưa có bài báo nào",
    "pubmed.emptyDesc": "Nhập từ khóa tìm kiếm để khám phá các công bố y sinh mới nhất.",
    "pubmed.noResultsTitle": "Không tìm thấy bài báo nào",
    "pubmed.noResultsDesc": "Không có bản ghi PubMed nào phù hợp với từ khóa \"{query}\".",
    "pubmed.hideAbstract": "Ẩn tóm tắt",
    "pubmed.showAbstract": "Xem tóm tắt",
    "pubmed.meshTerms": "Thuật ngữ MeSH",
    "pubmed.exportBibtex": "BibTeX",
    "pubmed.exportRis": "RIS",
    "pubmed.viewOnPubmed": "Xem trên PubMed",
    "pubmed.authorsMore": "+{count} tác giả khác",
    "pubmed.meshMore": "+{count} thuật ngữ khác",
    "pubmed.unknownJournal": "Tạp chí không rõ",
    "pubmed.unknownDate": "Ngày không rõ",
    "pubmed.sourceNcbi": "Nguồn NCBI",
    "pubmed.sourceCache": "Bộ nhớ đệm local",
    "pubmed.sourceLocal": "Cơ sở dữ liệu local",
    "pubmed.resultsTitle": "Kết quả PubMed",
    "feature.pubmed.title": "Khám phá tài liệu PubMed",
    "feature.pubmed.text": "Tìm kiếm công bố y sinh, lọc theo tạp chí, dòng thời gian và xuất trích dẫn định dạng BibTeX, RIS.",
    "api.pubmed": "PubMed",
    "blast.history": "Lịch sử tra cứu",
    "blast.historyEmpty": "Chưa có lịch sử tra cứu nào",
    "blast.historyCount": "{count} lượt tìm kiếm đã lưu",
    "blast.historyClear": "Xóa toàn bộ lịch sử",
    "blast.historyLoad": "Tải lại",
    "blast.historyDelete": "Xóa mục này",
    "blast.backToBlast": "Quay lại BLAST",
    "blast.topHit": "Top tương đồng",
    "blast.hitsCount": "{count} căn gióng",
    "detail.proteinStructure": "Cấu trúc & Miền Protein",
    "detail.proteinStructureDesc": "Mô hình 3D dự đoán bởi AlphaFold và chú giải chức năng miền sinh học từ UniProtKB / PDB",
    "detail.alphaFoldViewer": "Mở mô hình 3D trên AlphaFold DB",
    "detail.uniProtEntry": "Xem hồ sơ đầy đủ trên UniProtKB",
    "detail.pdbSearch": "Tìm cấu trúc thực nghiệm PDB",
  },
  en: {
    "language.vi": "Tiếng Việt",
    "language.en": "English",
    ...
    "common.close": "Close",
    "common.open": "Open",
    "sidebar.toggleCollapse": "Toggle sidebar width",
    "dashboard.openFeature": "Open",
    "metric.providersActiveUnit": "Active",
    "search.foundRecords": "Found {count} matching records.",
    "blast.advancedHide": "Hide Advanced BLAST Parameters",
    "blast.advancedShow": "Advanced BLAST Parameters (Matrix, E-value, Gaps)",
    "blast.evalueCutoff": "E-value Cutoff",
    "blast.scoringMatrix": "Scoring Matrix",
    "blast.gapOpen": "Gap Open",
    "blast.gapExtend": "Gap Extend",
    "blast.hideAlignment": "Hide Alignment",
    "blast.viewAlignment": "View Alignment",
    "blast.pairwiseHeader": "Pairwise Alignment (Query vs Subject)",
    "blast.coordinates": "Coordinates",
    "blast.score": "Score",
    "blast.gaps": "Gaps",
    "blast.length": "Length",
    "blast.segmentSummary": "Full segment pair sequence is summarized via {source}. Length: {length} residues, Identity: {identity}%, E-value: {evalue}.",
    "toast.blastSubmitted": "BLAST job submitted: {jobId}",
    "toast.blastComplete": "BLAST search complete — {count} alignments found",
    "toast.blastTimedOut": "BLAST search timed out. Please try again.",
    "api.pubmedPlaceholder": "PubMed query…",
    "api.responseJson": "Response JSON",
    "api.requestFailed": "Request failed",
    "export.downloadFasta": "Download .FASTA",
    "export.downloadGenbank": "Download .GenBank (.gb)",
    "export.downloadBed": "Download .BED Exons",
    "export.downloadJson": "Download .JSON Metadata",
    "export.copyJson": "Copy JSON to Clipboard",
    "detail.confidence": "Confidence",
    "detail.confidenceHigh": "High",
    "detail.residues": "Residues",
    "detail.tooLargeForGc": "Too large for automatic GC calculation ({length} bp)",
    "detail.largeScaleTitle": "Large-scale sequence ({length} bp)",
    "detail.largeScaleDesc": "Detailed base counts are skipped for chromosome/scaffold scale records. You can browse and visualize the entire sequence in the Genome Browser below.",
    "detail.moreCharacters": "{count} more characters (copy to get full sequence)",
    "detail.showingOf": "Showing 1–{shown} of {total} {unit}",
    "browser.title": "Genome Browser",
    "browser.loading": "Initialising IGV Genome Browser…",
    "browser.loadingSub": "Fetching sequence from NCBI — this may take a few seconds.",
    "browser.unavailable": "Genome Browser Unavailable",
    "browser.unavailableSub": "No valid sequence accession or ID available for this record.",
    "browser.viewOnNcbi": "View on NCBI",
    "browser.error": "Genome Browser Error",
    "browser.rateLimit": "NCBI Rate Limit Reached",
    "browser.rateLimitSub": "NCBI is temporarily blocking requests from this server. This usually resolves within a few minutes. You can still view the sequence directly on NCBI.",
    "browser.tryAgain": "Try again",
    "browser.region": "Region",
    "error.somethingWrong": "Something went wrong",
    "error.description": "An unexpected error occurred in the application. Please try again or return to the home page.",
    "error.tryAgain": "Try again",
    "error.home": "Home",
    "pubmed.badge": "NCBI PubMed Literature",
    "pubmed.title": "PubMed Biomedical Literature",
    "pubmed.desc": "Search biomedical research literature directly from NCBI PubMed with full abstracts, MeSH terms, and BibTeX / RIS citation export.",
    "pubmed.placeholder": "Enter medical term or gene name, e.g. cancer, BRCA1, covid...",
    "pubmed.searchButton": "Search",
    "pubmed.searching": "Searching...",
    "pubmed.quickExamples": "Quick queries",
    "pubmed.statArticles": "Articles",
    "pubmed.statWithAbstract": "With Abstract",
    "pubmed.statJournals": "Journals",
    "pubmed.statWithDoi": "With DOI",
    "pubmed.timeline": "Publication Timeline",
    "pubmed.topJournals": "Top Journals",
    "pubmed.emptyTitle": "No articles yet",
    "pubmed.emptyDesc": "Enter a search term to explore the latest biomedical research publications.",
    "pubmed.noResultsTitle": "No articles found",
    "pubmed.noResultsDesc": "No PubMed records found matching \"{query}\".",
    "pubmed.hideAbstract": "Hide Abstract",
    "pubmed.showAbstract": "Show Abstract",
    "pubmed.meshTerms": "MeSH Terms",
    "pubmed.exportBibtex": "BibTeX",
    "pubmed.exportRis": "RIS",
    "pubmed.viewOnPubmed": "View on PubMed",
    "pubmed.authorsMore": "+{count} more authors",
    "pubmed.meshMore": "+{count} more",
    "pubmed.unknownJournal": "Unknown journal",
    "pubmed.unknownDate": "Unknown date",
    "pubmed.sourceNcbi": "NCBI Source",
    "pubmed.sourceCache": "Local Cache",
    "pubmed.sourceLocal": "Local DB",
    "pubmed.resultsTitle": "PubMed Results",
    "feature.pubmed.title": "PubMed Literature",
    "feature.pubmed.text": "Search biomedical publications, filter by journal and timeline, and export BibTeX / RIS citations.",
    "api.pubmed": "PubMed",
    "blast.history": "Search History",
    "blast.historyEmpty": "No search history recorded yet",
    "blast.historyCount": "{count} searches saved",
    "blast.historyClear": "Clear all history",
    "blast.historyLoad": "Reload",
    "blast.historyDelete": "Delete item",
    "blast.backToBlast": "Back to BLAST",
    "blast.topHit": "Top match",
    "blast.hitsCount": "{count} alignments",
    "detail.proteinStructure": "Protein Architecture & Structure",
    "detail.proteinStructureDesc": "AlphaFold predicted 3D structure and UniProtKB / PDB functional domain annotations",
    "detail.alphaFoldViewer": "View 3D Model on AlphaFold DB",
    "detail.uniProtEntry": "View Full Entry on UniProtKB",
    "detail.pdbSearch": "Search Experimental Structures on PDB",
  }
};
